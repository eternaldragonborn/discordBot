...
class Events(Cog_Ext):
  ...
  async def on_message(self, msg):
    if msg.author != self.bot.user and not msg.author.bot:
      if re.search(r'[rR啊阿ㄚ痾]{4,}', msg.content):
      ...
      elif SAO.search(msg.content.lower()) or SAO.search(msg.author.display_name) or "<:098:719589717955575879>" in msg.content:   #太快ㄌ
        ...
        await msg.add_reaction("\N{THUMBS DOWN SIGN}")
        #await msg.delete()
      elif "並沒有" in msg.content or "不要瞎掰" in msg.content:
